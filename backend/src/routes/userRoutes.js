...
import { bookingDetails, cancelRequest, createBooking, listBookings, verifyPayment } from "../controller/bookingController.js";
...
userRouter.post("/cancelRequest", cancelRequest)
